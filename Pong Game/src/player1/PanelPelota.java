...
public class PanelPelota extends JPanel implements Runnable {
	...
	public PanelPelota() {
		...
		try {
			...
			tibrvListener = new TibrvListener(Tibrv.defaultQueue(), new MyTibCallback(), transport, "PLAYER1", null);
	...
	public void keyPressed(KeyEvent evt, TibrvMsg msg) {
		...
		case KeyEvent.VK_W:
			player1FlagArr = true;
			// send msg if player1FlagArr=true
			sendPlayer2UP();
			break;
		case KeyEvent.VK_S:
			player1FlagAba = true;
			// send msg if player1FlagAba=true
			sendPlayer2DOWN();
			break;
		}
	}

	private void sendPlayer2UP() {
